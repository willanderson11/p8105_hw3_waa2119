...
Our data set specifically contains weather observations only within the
state of New York
...
temperature value and vice versa. The number of days with snowfall
between 0 and 100 mm varies drastically each year. Some years have very
little, if any days, with snowfall while many have over 12 days and some
have over 20 days with snowfall between 0 and 100 mm.
