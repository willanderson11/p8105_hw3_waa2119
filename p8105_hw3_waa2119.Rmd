...
Our data set specifically contains weather observations only within the state of New York
...
max_min_temp_graph = 
  ...
  labs(
    ...
    title = "NY Weather Stations Temps",
...
snowfall_dist_graph = 
  ...
  ggplot(snowfall_dist, aes(x = Year, y = count)) + 
  ...
  labs(
    ...
    title = "Snowfall 0-100 mm per Year",
...
We can see that maximum and minimum temperatures in New York have a positively linear correlation. This makes sense as we would expect a high minimum temperature value to correlate with a high maximum temperature value and vice versa. The number of days with snowfall between 0 and 100 mm varies drastically each year. Some years have very little, if any days, with snowfall while many have over 12 days and some have over 20 days with snowfall between 0 and 100 mm. 